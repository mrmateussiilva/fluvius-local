...
const props = defineProps({
  ...
  conversationSearchTerm: { type: String, default: '' },
  isSearchResult: { type: Boolean, default: false },
  isActiveSearchResult: { type: Boolean, default: false },
});
...
provideMessageContext({
  ...
  conversationSearchTerm: computed(() => props.conversationSearchTerm),
  variant,
  orientation,
  isBotOrAgentMessage,
  shouldGroupWithNext,
  ...
  <div
    ...
    :class="[
      flexOrientationClass,
      {
        ...
        'bg-n-brand/5': isSearchResult,
        'outline outline-2 outline-n-brand': isActiveSearchResult,
      },
    ]"
  >
